...
Public paid routes may use x402 or MPP access depending on deployment. Payment and settlement flows are handled by the backend route infrastructure, not by the StrategiX app.
