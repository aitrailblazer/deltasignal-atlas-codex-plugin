...
func main() {
	...
	mcp.AddTool(server, tool("deltasignal_resolve_river_tripcode", "Resolves a TF-RIVER issuer thesis graph from GCS. Use this when the subscriber starts from a River TripCode or issuer River. Typical price: $0.05.", riverTripCodeSchema()), client.resolveRiverTripCode)
